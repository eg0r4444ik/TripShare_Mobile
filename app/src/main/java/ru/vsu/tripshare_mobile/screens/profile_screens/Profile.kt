...
@Composable
fun Profile(cars: List<CarModel>?, user: UserModel, navController: NavController) {
    ...
    Column(
        ...
        var curr = remember { mutableStateOf(0) }
        ...
        Cars(myCars, user, user, navController = navController)
    }
